...
# Definindo a função para plotar os dados
...
# Iniciando o loop para os dados dos meses informados através do shell
for i in sys.argv[1:]:
    
    sinasc = pd.read_csv(f'./input/SINASC_RO_2019_{i.upper()}.csv')
